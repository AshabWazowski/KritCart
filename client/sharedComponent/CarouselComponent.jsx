    ...
    const handleCarouselClick = (e) =>{
     ...
     return (
       <div className="bg-gray-100 w-full  flex items-center justify-center">
         ...
         <div>
         <Image src={Banner1} alt='Slide1' className='w-[100%] h-[100%] bg-contain cursor-pointer'/>
         </div>
         <div>
         <Image src={Banner2} alt='Slide2' className='w-[100%] h-[100%] bg-contain cursor-pointer'/>
         </div>
         <div>
         <Image src={Banner3} alt='Slide3' className='w-[100%] h-[100%] bg-contain cursor-pointer'/>
         </div>
         <div>
         <Image src={Banner4} alt='Slide4' className='w-[100%] h-[100%] bg-contain cursor-pointer'/>
         </div>
         </Carousel>
       </div>
     )
